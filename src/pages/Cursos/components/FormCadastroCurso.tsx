...
import { getPropriedade } from "../../../utils/curso";
...
export function FormCadastroCurso({ curso, loading, buttonText, onFinish }: FormCadastroCursoProps) {
  ...
  return (
    ...
    >
      <Row gutter={16}>
        <Col span={12}>
          <Form.Item label="Nome" name="nome" rules={[{ required: true, message: "Please input your username!" }]}>
            <Input />
          </Form.Item>
        </Col>
        <Col span={12}>
          <Form.Item label="Titulação" name="titulacao">
            <Select>
        ...
        <Col span={12}>
          <Form.Item label="Número de Semestres" name="semestres">
